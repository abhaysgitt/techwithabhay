    ...
    <main className="container relative mx-auto scroll-my-12 overflow-auto p-4 md:p-16 print:p-12">
      ...
      >
        ...
        >
          ...
          <Section id="about">
            <div className="flex items-center justify-between">
              <h2 className="inline-flex w-fit h-fit rounded-lg bg-[#393b3d] text-background px-2 py-0.5 text-sm font-bold">About</h2>
            </div>
          ...
          <Section id="work" className="scroll-mt-16">
            <h2 className="inline-flex w-fit rounded-lg bg-[#393b3d] text-background px-2 py-0.5 text-sm font-bold">Work Experience</h2>
            <WorkTimeline experiences={RESUME_DATA.work} />
          </Section>

          {/* Open Source Section */}
          <Section id="open-source" className="scroll-mt-12 print-force-new-page">
            <h2 className="inline-flex w-fit rounded-lg bg-[#393b3d] text-background px-2 py-0.5 text-sm font-bold"> Open-Source Contributions</h2>
            <OpenSourceSection repositories={repoData} />
          </Section>
         ...
         {/*  <FeaturedRepos 
          ...
          {RESUME_DATA.achievements && RESUME_DATA.achievements.length > 0 && (
            <div className="scroll-mt-16" id="achievements-news">
              <AchievementsNewsSection achievements={RESUME_DATA.achievements} />
            </div>
          )}
          ...
          <Section id="projects" className="print-force-new-page scroll-mb-12">
            <h2 className="inline-flex w-fit rounded-lg bg-[#393b3d] text-background px-2 py-0.5 text-sm font-bold">Projects</h2>
            <div className="mt-3 grid grid-cols-1 gap-3 md:grid-cols-2 lg:grid-cols-3 print:grid-cols-3 print:gap-2">
          ...
          <Section id="projects" className="print-force-new-page scroll-mb-12">
            <h2 className="inline-flex w-fit rounded-lg bg-[#393b3d] text-background px-2 py-0.5 text-sm font-bold">Products</h2>
            <div className="mt-3 grid grid-cols-1 gap-3 md:grid-cols-2 lg:grid-cols-3 print:grid-cols-3 print:gap-2">
          ...
          <Section id="skills" className="scroll-mb-12">
            <h2 className="inline-flex w-fit rounded-lg bg-[#393b3d] text-background px-2 py-0.5 text-sm font-bold">Skills</h2>
            <div className="mt-3">
              <InteractiveSkills skills={Array.from(RESUME_DATA.skills)} />
            </div>
          </Section>

          <Section id="education" className="scroll-mb-12">
            <h2 className="inline-flex w-fit rounded-lg bg-[#393b3d] text-background px-2 py-0.5 text-sm font-bold">Education</h2>
            <div className="mb-2">
          ...
          <Section id="blog" className="scroll-mt-12">
            <div className="mb-2 flex items-center justify-between">
              <div>
                <h2 className="inline-flex w-fit rounded-lg bg-[#393b3d] text-background px-2 py-0.5 text-sm font-bold">Blog Posts</h2>
              </div>
              <Button
                variant="ghost"
                size="sm"
                asChild
                className="inline-flex w-fit h-fit rounded-lg bg-[#626364] text-background px-2 py-0.5 text-sm font-bold"
              >
