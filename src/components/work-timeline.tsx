...
const companyLogos: Record<string, string> = {
  "Cloud Native Computing Foundation (CNCF)": "/cncf.png",
  "Self-Directed & Community Learner": "/memoji.jpeg",
  "Cloud Automation Projects": "/github-action-logo.png",
  "Foundations in Software & Systems": "/github.png",
...
export const WorkTimeline: React.FC<WorkTimelineProps> = ({ experiences }) => {
  ...
  // Only show top 2 experiences initially
