...
export const PublishedWorkSection: React.FC<PublishedWorkSectionProps> = ({
  ...
  // Only show 2 publications by default
  const visiblePublications = showAll ? publications : publications.slice(0, 2);
  const hasMorePublications = publications.length > 2;

  return (
    <Section className="mb-6" id="publications">
      <div className="mb-4">
        <h2 className="inline-flex w-fit rounded-lg bg-[#393b3d] text-background px-2 py-0.5 text-sm font-bold">Academic Publications</h2>
