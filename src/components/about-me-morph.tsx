...
const markdownStyles = {
  ...
  h1: "text-base font-bold mb-4 border-b pb-2 text-zinc-800 dark:text-zinc-200",
  h2: "text-base font-bold mt-6 mb-3 text-zinc-800 dark:text-zinc-200",
  h3: "text-base font-semibold mt-5 mb-2 text-zinc-800 dark:text-zinc-200",
...
export const AboutMeMorph = () => {
  ...
  return (
    <div className="relative">
      <Button
        className="flex h-6 w-fit items-center gap-2"
        variant="outline"
