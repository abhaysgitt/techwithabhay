...
import { SiRedis, SiPostgresql, SiTailwindcss, SiNextdotjs, SiTypescript, SiMongodb, SiReact, SiExpress, SiJavascript, SiPython, SiC, SiCplusplus, SiJava, SiMysql, SiGit, SiDocker, SiVercel, SiAws, SiFirebase, SiOpenai } from 'react-icons/si'
...
const Services = ({ theme }) => {
    ...
    return (
        <section id="services" className={`py-5 relative overflow-hidden ${
            ...
            {/* Content Container */}
             <GridBackground theme={theme} colorScheme="ocean" />
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 py-10">
                ...
                <div className="mb-24 opacity-0 animate-[fadeInUp_1s_ease-out_forwards]">
                    <h1 className={`text-2xl md:text-6xl font-bold mb-4 text-center opacity-0 animate-[slideInLeft_1s_ease-out_forwards] bg-gradient-to-r ${
                        theme === 'dark' 
  ...
  <div className={`backdrop-blur-md rounded-2xl p-6 border transition-all duration-300 hover:scale-105 ${
      ...
      <div className="space-y-3">
          <div className="flex items-center">
              <SiJavascript className="text-2xl mr-3 text-yellow-400" />
              <span className="text-blue-800 dark:text-blue-100">JavaScript</span>
          </div>
          <div className="flex items-center">
              <SiPython className="text-2xl mr-3 text-blue-500" />
              <span className="text-blue-800 dark:text-blue-100">Python</span>
          </div>
          <div className="flex items-center">
              <SiC className="text-2xl mr-3 text-gray-600" />
              <span className="text-blue-800 dark:text-blue-100">C</span>
          </div>
          <div className="flex items-center">
              <SiCplusplus className="text-2xl mr-3 text-blue-600" />
              <span className="text-blue-800 dark:text-blue-100">C++</span>
          </div>
      </div>
  </div>
  ...
  <div className={`backdrop-blur-md rounded-2xl p-6 border transition-all duration-300 hover:scale-105 ${
      ...
      <div className="space-y-3">
          <div className="flex items-center">
              <FaReact className={`text-2xl mr-3 ${theme === 'dark' ? 'text-cyan-400' : 'text-cyan-600'}`} />
              <span className="text-blue-800 dark:text-blue-100">React.js</span>
          </div>
          <div className="flex items-center">
              <SiNextdotjs className={`text-2xl mr-3 ${theme === 'dark' ? 'text-white' : 'text-black'}`} />
              <span className="text-blue-800 dark:text-blue-100">Next.js</span>
          </div>
          <div className="flex items-center">
              <SiTailwindcss className={`text-2xl mr-3 ${theme === 'dark' ? 'text-cyan-400' : 'text-cyan-600'}`} />
              <span className="text-blue-800 dark:text-blue-100">Tailwind CSS</span>
          </div>
          <div className="flex items-center">
              <SiTypescript className={`text-2xl mr-3 ${theme === 'dark' ? 'text-blue-400' : 'text-blue-600'}`} />
              <span className="text-blue-800 dark:text-blue-100">TypeScript</span>
          </div>
          <div className="flex items-center">
              <FaNodeJs className={`text-2xl mr-3 ${theme === 'dark' ? 'text-green-400' : 'text-green-600'}`} />
              <span className="text-blue-800 dark:text-blue-100">Node.js</span>
          </div>
          <div className="flex items-center">
              <SiExpress className={`text-2xl mr-3 ${theme === 'dark' ? 'text-gray-400' : 'text-gray-600'}`} />
              <span className="text-blue-800 dark:text-blue-100">Express.js</span>
          </div>
      </div>
  </div>
  ...
  <div className={`backdrop-blur-md rounded-2xl p-6 border transition-all duration-300 hover:scale-105 ${
      ...
      <div className="space-y-3">
          <div className="flex items-center">
              <SiMongodb className={`text-2xl mr-3 ${theme === 'dark' ? 'text-green-400' : 'text-green-600'}`} />
              <span className="text-blue-800 dark:text-blue-100">MongoDB</span>
          </div>
          <div className="flex items-center">
              <SiMysql className={`text-2xl mr-3 ${theme === 'dark' ? 'text-blue-400' : 'text-blue-600'}`} />
              <span className="text-blue-800 dark:text-blue-100">MySQL</span>
          </div>
          <div className="flex items-center">
              <SiPostgresql className={`text-2xl mr-3 ${theme === 'dark' ? 'text-blue-300' : 'text-blue-700'}`} />
              <span className="text-blue-800 dark:text-blue-100">PostgreSQL</span>
          </div>
          <div className="flex items-center">
              <SiGit className={`text-2xl mr-3 ${theme === 'dark' ? 'text-orange-400' : 'text-orange-600'}`} />
              <span className="text-blue-800 dark:text-blue-100">Git</span>
          </div>
          <div className="flex items-center">
              <SiVercel className={`text-2xl mr-3 ${theme === 'dark' ? 'text-gray-200' : 'text-gray-800'}`} />
              <span className="text-blue-800 dark:text-blue-100">Vercel</span>
          </div>
          <div className="flex items-center">
              <SiFirebase className={`text-2xl mr-3 ${theme === 'dark' ? 'text-yellow-300' : 'text-yellow-600'}`} />
              <span className="text-blue-800 dark:text-blue-100">Firebase</span>
          </div>
          <div className="flex items-center">
              <SiOpenai className={`text-2xl mr-3 ${theme === 'dark' ? 'text-pink-400' : 'text-pink-600'}`} />
              <span className="text-blue-800 dark:text-blue-100">OpenAI API</span>
          </div>
      </div>
  </div>
