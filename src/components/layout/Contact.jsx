...
export default function Contact({ theme }) {
    ...
    return (
        <section id="contact" className={`relative py-10 min-h-screen ${   theme === "dark" ? '60a5fa' : '#2563eb' }`}>
            <GridBackground theme={theme} colorScheme="lavender" />
            <div className="max-w-7xl mx-auto px-6 lg:px-8">
                ...
                <div className="max-w-6xl mx-auto">
                    <div className="grid md:grid-cols-2 gap-8 md:gap-16 items-center">
                        ...
                        <div className={`rounded-2xl p-6 border transition-all duration-300 hover:scale-105 ${  theme === 'dark' ? 'bg-gray-900/60 border-blue-500/30 hover:border-blue-400/50' : 'bg-white/80 border-blue-300/50 hover:border-blue-500/70' }`}>
