...
const Projects = () => {
    ...
    return (
        <section id="projects" className={`relative py-24 min-h-screen ${   theme === "dark" ? '60a5fa' : '#2563eb' }`}>
             <GridBackground theme={theme} colorScheme="emerald" />
            <div className="max-w-7xl mx-auto px-6 lg:px-8">
                <div className="text-center mb-16">
                    ...
                    <p className="text-lg mt-6 max-w-2xl mx-auto text-gray-600 dark:text-gray-100">
