...
> = ({ achievements }) => {
  ...
  // Only show 2 achievements by default
  const visibleAchievements = showAll ? achievements : achievements.slice(0, 2);
  const hasMoreAchievements = achievements.length > 2;

  return (
    <Section className="mb-3" id="achievements-news">
      <div className="mb-2">
        <h2 className="inline-flex w-fit rounded-lg bg-[#393b3d] text-background px-2 py-0.5 text-sm font-bold">Achievements & News</h2>
